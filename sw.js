...
const SHELL = [
  ...
  'js/main.js', 'js/db.js', 'js/util.js', 'js/icons.js', 'js/ui.js', 'js/stats.js', 'js/charts.js', 'js/sample.js', 'js/ocr.js', 'js/scorecard.js', 'js/coursesearch.js', 'js/kga.js', 'data/kga-ratings.json',
